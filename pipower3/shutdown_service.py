...
class ShutdownService():
    ...
    def loop(self):
        while self.running:
            ...
            is_charging = self.spc.read_is_charging()
            ...
            if is_charging != self.last_is_charging:
                if is_charging:
                    self.log.info("Charging")
                else:
                    self.log.info("Not charging")
                self.last_is_charging = is_charging
